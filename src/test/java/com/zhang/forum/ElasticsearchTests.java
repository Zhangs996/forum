...
import com.zhang.forum.dao.elasticsearch.DiscussPostRepository;
...
//    @Qualifier("client")
    ...
    public void testExist(){
        boolean exists =discussRepository.existsById(241);
...
//        discussRepository.saveAll(discussMapper.selectDiscussPosts(113, 0, 100,0));
//        discussRepository.saveAll(discussMapper.selectDiscussPosts(114, 0, 100,0));
//        discussRepository.saveAll(discussMapper.selectDiscussPosts(115, 0, 100,0));
        discussRepository.saveAll(discussMapper.selectDiscussPosts(116, 0, 100,0));
    }
    ...
    public void noHighlightQuery() throws IOException {
        ...
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder()
                ...
                .sort(SortBuilders.fieldSort("type").order(SortOrder.DESC))//排序条件
